...
######### Creates plot ##########
png(file = "./R/ExData_Plotting1/Plot4.png", width = 480, height = 480)
par(mfrow = c(2,2))
plot(PC$DateTime, PC$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
...
plot(PC$DateTime, PC$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()  